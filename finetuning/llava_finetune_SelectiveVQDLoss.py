...
class LLaVATrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):    # override the loss function
        ...
        option_ids = [tokenizer.encode(option, add_special_tokens=False)[0] for option in ['Yes', 'No']]
        ...
        for input_ids in input_ids_batch:
            input_ids = torch.where(input_ids!=-200, input_ids, tokenizer.pad_token_id)
            input_text = tokenizer.decode(input_ids, skip_special_tokens=True)
            input_text_zero_phase = input_text.split('ASSISTANT:')[0] + 'ASSISTANT:'
            zero_phase_answer = input_text.split('ASSISTANT:')[1].split('USER:')[0]
            ...
            input_ids_zero_phase = tokenizer(input_text_zero_phase, return_tensors="pt")["input_ids"]
